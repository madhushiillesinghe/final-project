DROP DATABASE IF EXISTS project_agri_company;
...
CREATE TABLE supplier_order_detail(
                                      ...
                                      FOREIGN KEY (sup_o_id) REFERENCES supplier_order(sup_order_id) ON DELETE CASCADE ON UPDATE CASCADE
);
